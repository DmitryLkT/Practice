...
public class ChessBoard {
    ...
    public boolean castling0() {
        if(nowPlayer.equals("White")) {
            ...
            if(board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") &&
                ...
                if(board[0][0].getColor().equals("White") && board[0][4].getSymbol().equals("White") &&
    ...
    public boolean castling7() {
        if(nowPlayer.equals("Black")) {
            if(board[7][4] == null || board[7][7] == null) {
                return false;
            }
            ...
            if(board[7][4].getSymbol().equals("K") && board[7][0].getSymbol().equals("R") &&
                ...
                if(board[7][4].getColor().equals("Black") && board[7][0].getColor().equals("Black") &&
                        board[7][4].check && board[7][0].check && new King("Black").isUnderAttack(this, 7,2)) {
                    board[7][4] = null;
